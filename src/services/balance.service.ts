...
export class BalanceService {
    ...
    async getBalance(walletId: string, tokenId: string) {
        return this.repository.find(walletId, tokenId);
    }
    ...
    async updateBalance(walletId: string, tokenId: string, balance: bigint, blockNumber: bigint) {
