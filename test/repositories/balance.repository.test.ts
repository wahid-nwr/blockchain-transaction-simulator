...
describe("BalanceRepository",()=>{
    ...
    it ("should create balance snapshot",
        async() => {
            ...
            expect(result.blockNumber)
                .toBe(100n);
        }
    );

    it ("should update existing balance snapshot",
        async() => {
    ...
    it ("should find balance by wallet and token",
        async() => {
            await repository.upsert({
                walletId:wallet.id,
                tokenId:token.id,
    ...
    it ("should find balances by wallet",
        async() => {
